...
const Breathing = () => (
  <div className="px-5 pt-16 flex flex-col items-center text-center relative">
    ...
    <div className="relative mt-12">
      <div className="absolute inset-0 bg-monet-sky blur-3xl opacity-50 rounded-full animate-breathe" />
    ...
    <span className="mt-8 px-4 py-2 rounded-full surface text-sage-deep text-sm font-semibold">
      준비 중 🌿
    </span>
  </div>
);
